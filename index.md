...
<br>
## EduSpectro4X
PCにUSBで接続し、露光時間設定とデータコマンドを受け、データを出力します。EduSpectro LabはProcessingプログラムで書かれていますが、他の言語でもシリアル入出力ができるものであれば通信が可能です。
...
10回累積計測して出力することでノイズの軽減を行なっています。分光センサーC12880MAは288画素ですが、Catmull-Rom3次補間により本来のサンプリング点（4点に1点の生データ）を維持しつつ、視覚的に自然で、ピーク位置を特定しやすい 1149 点のデータを生成します。
...
### 通信プロトコル（他言語開発用）
PythonやC#、Rustなど、他のプログラミング言語でも本機を制御できるように、通信仕様を公開します。
